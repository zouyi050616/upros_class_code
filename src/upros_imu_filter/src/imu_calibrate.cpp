#include "upros_imu_filter/imu_calibrate.h"
#include "tf/tf.h"
#include <tf/transform_broadcaster.h>
#include <geometry_msgs/PoseWithCovarianceStamped.h>
#include <std_msgs/String.h>

ROSIMU::ROSIMU(ros::NodeHandle nh, ros::NodeHandle pnh) : //  Members default values
                                                          nh_(nh),
                                                          pnh_(pnh),
                                                          perform_calibration_(true),
                                                          is_calibrated_(false)
{
    raw_sub_ = nh_.subscribe("/imu/data", 5, &ROSIMU::rawCallback, this);
    ...
    imu_pub_ = nh_.advertise<sensor_msgs::Imu>("/imu/filtered", 1000);
