...
public:
    ArmJointTrajectory(std::string name) :
        as_(nh, name, false),
        action_name_(name)
    {
    ...
    void goalCB()
    {
        ...
        std::vector<trajectory_msgs::JointTrajectoryPoint> points_ =  as_.acceptNewGoal()->trajectory.points;
...
{
    ros::init(argc, argv, "s2a_arm_driver");
